package org.createyourhumanity.angular.config;

import java.util.*;
import org.createyourhumanity.angular.security.*;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        .and()
            ...
            .antMatchers("/api/formula-data/**").permitAll()
            .antMatchers("/api/friends/**").permitAll()
            .antMatchers("/api/groups/**").permitAll()
            .antMatchers("/api/authenticatedUserWidthFormulaData").permitAll()
            .antMatchers("/api/allUsersWidthFormulaDataAndFriends").permitAll()
            .antMatchers("/api/mindmaps/**").permitAll()
